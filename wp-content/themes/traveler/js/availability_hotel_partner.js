            ...
            self.calendar.fullCalendar({
                ...
                eventRender: function(event, element, view) {
                    ...
                    if (event.status == 'available') {
                        if ($('.calendar-content', this.container).data('price-by-per-person') == 'on') {
                            html += '<div class="price">'+ st_params.text_adult_price +': '+ event.adult_price + '</div>'
                            html += '<div class="price">'+ st_params.text_child_price +': '+ event.child_price + '</div>'
                        } else {
        ...
        $('.calendar-wrapper').each(function(index, el) {
            ...
            $('#calendar_submit', t).click(function(event) {
                ...
                data.push({
                    ...
                    value: $('.calendar-content', t).data('price-by-per-person') == 'on' ? true : false || false
                });
