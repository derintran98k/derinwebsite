                    ...
                    <a href="<?php echo esc_url(home_url('/')) ?>">
                        ...
                        if (!empty($logo_light) && isset($logo_light)) : ?>
                            <img src="<?php echo esc_url($logo_light) ?>"
                                 alt="<?php esc_html_e("logo", ST_TEXTDOMAIN) ?>"/>
                        <?php
                        else : ?>
                ...
                <div class="menu-right-item">
                    <a title="" class="btn btn-white sts-popup"
                       ...
                       data-effect="mfp-zoom-in">
                        <?php echo esc_html__('BOOK YOUR STAY', ST_TEXTDOMAIN); ?>
                    </a>
                </div>
            </div>
        </div>
                    ...
                    <li>
                        <a href="<?php echo esc_url($social_facebook_url) ?>" target="_blank">
                            <img
                                    ...
                                    alt="<?php esc_attr_e('Facebook', ST_TEXTDOMAIN) ?>"/>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo esc_url($social_instagram_url) ?>" target="_blank">
                            <img
                                    ...
                                    alt="<?php esc_attr_e('Instagram', ST_TEXTDOMAIN) ?>"/>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo esc_url($social_twitter_url) ?>" target="_blank">
                            <img
                                    ...
                                    alt="<?php esc_attr_e('Twitter', ST_TEXTDOMAIN) ?>"/>
                        </a>
                    </li>
                </ul>
            </div>
               ...
               <div class="control-right">
                   <div class="option-item">
                       <div class="option-mid">
                           <div class="location-phone">
                        <span class="icon">
                                <img src="<?php echo get_template_directory_uri()."/v2/images/assets/phone-dial-black.svg";?>" alt="<?php esc_html_e("logo",ST_TEXTDOMAIN) ?>" />
                            </span>
                               <a href="" title="">
                                <span class="number-phone">
                                    <?php if(!empty($st_contact_number) && isset($st_contact_number)){
