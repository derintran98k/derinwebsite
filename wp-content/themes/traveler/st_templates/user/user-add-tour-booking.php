      			...
      			<div class="panel-body">
	      			...
	      			<div class="row st_check_book_none">
	      				<div class="col-xs-12 col-sm-5-column">
	      					<div class="form-group">
	      						<label for="type-tour-wrapper" class="head_bol"><?php _e('Type tour', ST_TEXTDOMAIN); ?>: <span id="label_type_tour"></span></label>
	      						<div style="display:none" id="type-tour-wrapper"></div>
	      					</div>
	      				</div>
	      				<div class="col-xs-12 col-sm-5-column">
	      					<div class="form-group">
	      						<label for="max_people" class="head_bol"><?php _e('Max people', ST_TEXTDOMAIN); ?>:
      					...
      					<div class="col-xs-12 col-sm-5-column">
      						<div class="form-group">
		      					<label for="adult_price" class="head_bol"><?php _e('Adult Price', ST_TEXTDOMAIN); ?>: <span id="label_adult_price"></span></label>
		      					<input id="adult_price" readonly type="hidden" name="adult_price" value="" class="form-control">
		      				</div>
      					</div>
      					<div class="col-xs-12 col-sm-5-column">
      						<div class="form-group">
		      					<label for="child_price" class="head_bol"><?php _e('Children Price', ST_TEXTDOMAIN); ?>: <span id="label_child_price"></span></label>
		      					<input id="child_price" readonly type="hidden" name="child_price" value="" class="form-control">
		      				</div>
      					</div>
      					<div class="col-xs-12 col-sm-5-column">
      						<div class="form-group">
		      					<label for="infant_price" class="head_bol"><?php _e('Infant Price', ST_TEXTDOMAIN); ?>: <span id="label_infant_price"></span></label>
