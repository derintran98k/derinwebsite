    ...
    <div class="row item st_partner_payout_item control">
        <div class="col-md-8">
            <div class='form-group form-group-icon-left'>
                ...
                <input  name="st_partner_price" type="number"  placeholder="<?php _e("Amount",ST_TEXTDOMAIN) ?>" class="form-control" value="<?php echo esc_attr(STInput::request('st_partner_price',$price_min)) ?>">
    ...
    <div class="row st_partner_payout_item_paypal item st_partner_payout_item" style="display:none;">
        <div class="col-md-8">
            <div class='form-group form-group-icon-left'>
                ...
                <input  name="st_partner_paypal_email" type="text"  placeholder="<?php _e("Paypal Email",ST_TEXTDOMAIN) ?>" class="form-control" value="<?php echo esc_attr(STInput::request('st_partner_paypal_email',get_user_meta($current_user->ID , 'st_partner_paypal_email' , true))) ?>">
            </div>
        </div>
        <div class="col-md-8">
            <div class='form-group form-group-icon-left'>
    ...
    <div class="row st_partner_payout_item_stripe item st_partner_payout_item" style="display:none;">
        <div class="col-md-8">
            <div class='form-group form-group-icon-left'>
                ...
                <input  name="st_partner_stripe_key" type="text"  placeholder="<?php _e("Secret Key",ST_TEXTDOMAIN) ?>" class="form-control" value="<?php echo esc_attr(STInput::request('st_partner_stripe_key',get_user_meta($current_user->ID , 'st_partner_stripe_key' , true))) ?>">
            </div>
        </div>
    </div>
