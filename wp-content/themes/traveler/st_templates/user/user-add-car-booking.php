      				...
      				<div class="row">
      					...
      					<div class="col-xs-12 col-sm-6">
      						<div class="form-group">
		      					...
		      					?>
		      					<input id="pick_up" type="hidden" name="location_id" value="<?php /*echo $pick_up; */?>" data-post-type="location" class="form-control custom-form-control st_post_select_ajax " data-pl-name="<?php /*echo $pick_up_name; */?>">
		      				</div>
      					</div>
