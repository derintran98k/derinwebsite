...
<div class="col-lg-3 col-md-3 col-sm-3 col-xs-6 item-service grid-item has-matchHeight">
		...
		<div class="thumb">
	        <?php if(is_user_logged_in()){ ?>
	            ...
	            <div class="service-add-wishlist login <?php echo esc_attr(($data['status']) ? 'added' : ''); ?>" data-id="<?php echo esc_attr($post_translated); ?>" data-type="<?php echo esc_attr(get_post_type($post_translated)); ?>" title="<?php echo esc_attr(($data['status']) ? __('Remove from wishlist', ST_TEXTDOMAIN) : __('Add to wishlist', ST_TEXTDOMAIN)); ?>">
