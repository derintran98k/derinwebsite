        ...
        if (st_check_service_available('st_tours')) {
            ...
            if ($query->have_posts()) {
                if($style == 'style1'){
                    ...
                    echo '<div class="search-result-page st-tours service-slider-wrapper"><div class="st-hotel-result"><div class="owl-carousel  list-service-'. $style .'">';
                    while ($query->have_posts()):
                        $query->the_post();
                    ...
                    echo '</div>';
                    echo '<div class="search-result-page st-tours service-slider-wrapper col-md-9"><div class="st-hotel-result"><div class="owl-carousel  list-service-'. $style .'">';
                    while ($query->have_posts()):
                        $query->the_post();
