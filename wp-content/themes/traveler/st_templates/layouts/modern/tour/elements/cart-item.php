    ...
    <ul>
        ...
        <li class="ad-info">
            <ul>
                ...
                <?php } ?>
                <?php if($child_number) {?>
                    <li><span class="label"><?php echo __('Number of Children', ST_TEXTDOMAIN); ?></span><span class="value"><?php echo esc_html($child_number); ?></span></li>
                <?php } ?>
            ...
            <li>
                ...
                <p class="booking-item-payment-price-amount">
                    ...
                    foreach($car_package as $k_hp => $v_hp): ?>
                        <span class="pull-right">
                                    <?php echo esc_html($v_hp->car_name ). ' ('.TravelHelper::format_money($v_hp->car_price).') x ' . $v_hp->car_quantity; ?>
                                </span> <br />
                    <?php endforeach;?>
                </p>
            </li>
                ...
                <p class="booking-item-payment-price-amount">
                    ...
                    foreach($flight_package as $k_fp => $v_fp): ?>
                        <span class="pull-right">
                                    ...
                                    ?>
                                    <?php echo esc_html( $name_flight_package) . ' (' . $price_flight_package . ')'; ?>
                                </span> <br />
                    <?php endforeach;?>
                </p>
            </li>
