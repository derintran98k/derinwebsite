                    ...
                    <div class="item field-guest-new">
                        ...
                        <div class="dropdown" data-toggle="dropdown" id="dropdown-1">
                            <div class="render">
                                ...
                                <span class="adult" data-text="<?php echo __( 'Adult', ST_TEXTDOMAIN ); ?>" data-text-multi="<?php echo __( 'Adults', ST_TEXTDOMAIN ); ?>"><?php echo sprintf( _n( '%s Adult', '%s Adults', $adult_num_search, ST_TEXTDOMAIN ), $adult_num_search ) ?></span>
                                <span class="line"><?php echo esc_html__(" - ",ST_TEXTDOMAIN) ?></span>
                                <span class="children" data-text="<?php echo __( 'Child', ST_TEXTDOMAIN ); ?>"
                                      data-text-multi="<?php echo __( 'Children', ST_TEXTDOMAIN ); ?>"><?php echo sprintf( _n( '%s Child', '%s Children', $children_num_search, ST_TEXTDOMAIN ), $children_num_search ); ?></span>
                            </div>
                        </div>
