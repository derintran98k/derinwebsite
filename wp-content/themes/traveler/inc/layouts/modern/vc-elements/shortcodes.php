...
if(!function_exists('st_insta_image_ft')){
    function st_insta_image_ft($attr,$content = false)
    {
        $attr = shortcode_atts([
            'user_name' => '',
            'number_image' => ''
        ], $attr);
        return st()->load_template('layouts/modern/elements/image_of_instagram', '',  $attr);
    }
    st_reg_shortcode('st_insta_image', 'st_insta_image_ft');
}
