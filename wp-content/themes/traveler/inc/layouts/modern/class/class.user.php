    ...
    if ( !class_exists( 'STUser_f' ) ) {
        class STUser_f extends TravelerObject
        {
                ...
                switch ($step_name){
                    case 'basic_info':
                        ...
                        if($valid){
                            ...
                            $err = $this->stSetErrorMessage(array('st_title', 'st_content'));
                            echo json_encode(array(
                                'status' => false,
                                'err' => $err
                            ));
            ...
            public function st_partner_tour_tabs_payment($fields){
                $sc = STInput::get('sc');
                $id = STInput::get('id');
                if ((!empty($sc) && $sc == 'edit-activity')|| (!empty($sc) && $sc == 'create-activity')) {
                    array_push($fields, array(
                        'name' => 'payments',
                        'label' => __('Payments', ST_TEXTDOMAIN)
                    ));
                ...
                switch ($step_name){
                    case 'basic_info':
                        ...
                        if($valid){
                            ...
                            $err_field = array('st_title', 'st_content', 'hotel_star', 'st_desc', 'id_logo', 'hotel_booking_period');
