<div class="traveler-important-notice">
	<div class="traveler-registration-steps">
		<div class="feature-section st_admin_support">
			<div class="st_col_12">
				<h3>
					<?php echo __('Sync Price',ST_TEXTDOMAIN)?>
				</h3>
				...
				<p class="control-form">
					...
					<a class="button button-large button-primary" id="st_sync_price"><?php echo __('Sync Now',ST_TEXTDOMAIN)?><i class="fa fa-spin fa-spinner" style="display:none"></i></a>
				</p>
			</div>
		</div>
	</div>
