<?php
    ...
    if ( !class_exists( 'STDuplicateData' ) ) {
        class STDuplicateData extends STAdmin
        {
	        ...
	        {
		        add_submenu_page( 'st_traveler_option', __( 'Sync Price', ST_TEXTDOMAIN ), __( 'Sync Price', ST_TEXTDOMAIN ), 'manage_options', 'st_sync_price', [ $this, '_show_sync_price_page' ] );
	        }
            ...
            public function _show_sync_price_page()
	        {
		        ?>
                <div class="" style="margin: 5px 15px 2px;">
		            <h2><?php echo __('Sync Price', ST_TEXTDOMAIN); ?></h2>
		            <div class="st_sync_price_log"></div><br />
		            <button class="button button-primary st_btn_start_sync_price" data-text="<?php echo __('Sync Now', ST_TEXTDOMAIN); ?>" data-text-in="<?php echo __('Sync...', ST_TEXTDOMAIN); ?>"><?php echo __('Sync Now', ST_TEXTDOMAIN); ?></button>
